...
# repo/benchmarks/MAESTRO/mvt/part1 -> repo/
...
def configMemory(A, x1, y1, N):
    ...
    config_vals[0] = [first_addr_A, first_addr_A + (4 * N * 4), first_addr_A + (8 * N * 4), first_addr_A + (12 * N * 4), N, loopJit, first_addr_y1, first_addr_x1 + (12 * 4)]
    config_vals[1] = [first_addr_A + (1 * N * 4), first_addr_A + (5 * N * 4), first_addr_A + (9 * N * 4), first_addr_A + (13 * N * 4), first_addr_x1 + (1 * 4), N]
    config_vals[2] = [first_addr_A + (2 * N * 4), first_addr_A + (6 * N * 4), first_addr_A + (10 * N * 4), first_addr_A + (14 * N * 4), first_addr_y1, N, first_addr_x1 + (10 * 4), loopIit]
    config_vals[3] = [first_addr_A + (3 * N * 4), first_addr_A + (7 * N * 4), first_addr_A + (11 * N * 4), first_addr_A + (15 * N * 4), first_addr_x1 + (7 * 4), N]
