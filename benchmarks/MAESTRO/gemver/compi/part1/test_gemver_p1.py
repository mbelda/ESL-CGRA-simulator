...
# repo/benchmarks/MAESTRO/gemver/compi/part1/ -> repo/
...
def configMemory(A, u1, v1, u2, v2, N):
    ...
    # void gemver_v2_part1(int A[N][N],int u1[N], int v1[N],int u2[N], int v2[N])
    # 0: first_addr_A
    # 1: first_addr_u1
    # 2: first_addr_v1
    # 3: first_addr_u2
    ...
    config_vals[0] = []
    config_vals[1] = [first_addr_u1, first_addr_A] # 1, 0
    config_vals[2] = [first_addr_u2] # 3
    config_vals[3] = [first_addr_A, first_addr_v1, first_addr_v2] # 0, 2, 4
