...
# repo/benchmarks/MAESTRO/mmul/compi/ -> repo/
...
def configMemory(A, B, NI, NK, NJ):
    ...
    # void mmul(int A[NI][NK], int B[NK][NJ], int C[NI][NJ]){
    # 0: first_addr_A
    # 1: first_addr_B
    # 2: first_addr_C
       
    config_vals[0] = [first_addr_B, first_addr_C] # 1, 2
    config_vals[1] = [first_addr_C, first_addr_A] # 2, 0
    config_vals[2] = []
    config_vals[3] = []
