...
# repo/benchmarks/MAESTRO/gemm/compi/ -> repo/
...
def configMemory(A, B, C, NI, NK, NJ, alpha, beta):
    ...
    # void gemm(int A[NI][NK], int B[NK][NJ], int C[NI][NJ])
    # 0: first_addr_A
    # 1: first_addr_B
    # 2: first_addr_C

    config_vals[0] = [first_addr_C, first_addr_C] # 2, 2
    config_vals[1] = [first_addr_A] # 0
    config_vals[2] = [first_addr_B] # 1
    config_vals[3] = [first_addr_C] # 2
