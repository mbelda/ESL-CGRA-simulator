...
# repo/benchmarks/MAESTRO/atax/compi/part1 -> repo/
...
def configMemory(A, x, M, N):
    ...
    # int A[M][N], int x[N], int tmp[N]
    # 0: first_addr_A
    # 1: first_addr_x
    # 2: first_addr_tmp

    # Config vals
    config_vals[0] = [first_addr_A, first_addr_tmp] # 0, 2
    config_vals[1] = []
...
runKernel(load_addrs, max_it=2000000000, pr=["ROUT", "R0", "R1", "INST"], printVal=0)
