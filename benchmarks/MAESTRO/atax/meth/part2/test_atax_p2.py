...
# repo/benchmarks/MAESTRO/atax/part2 -> repo/
...
def configMemory(A, tmp, M, N):
    ...
    config_vals[0] = [first_addr_A, first_addr_y + (4 * 4), M, N]
    config_vals[1] = [N, M, first_addr_A + (9 * 4), first_addr_y + (13 * 4), loopJit, loopIit, first_addr_tmp]
    config_vals[2] = [first_addr_y + (2 * 4), first_addr_A + (6 * 4), N, M]
    config_vals[3] = [M, N, first_addr_y + (11 * 4), first_addr_A + (15 * 4), first_addr_tmp]
