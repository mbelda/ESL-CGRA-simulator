  ...
  func.func @mmul_majo(%arg0: memref<500xi32>, %arg1: memref<750xi32>, %arg2: memref<600xi32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to 20 {
      affine.for %arg4 = 0 to 30 {
        %0 = affine.for %arg5 = 0 to 25 iter_args(%arg6 = %c0_i32) -> (i32) {
          %1 = affine.load %arg0[%arg5 + %arg3 * 25] : memref<500xi32>
          %2 = affine.load %arg1[%arg4 + %arg5 * 30] : memref<750xi32>
          %3 = arith.muli %1, %2 : i32
          %4 = arith.addi %arg6, %3 : i32
          affine.yield %4 : i32
        }
        affine.store %0, %arg2[%arg4 + %arg3 * 30] : memref<600xi32>
      }
    }
    return
  }
