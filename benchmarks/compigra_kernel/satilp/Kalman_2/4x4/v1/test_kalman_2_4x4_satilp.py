...
def configMemory(A, Q, AP, NI):
    ...
    config_vals[0] = [first_addr_AT, first_addr_A] # 3, 0
    config_vals[1] = [first_addr_Q, first_addr_APA] # 1, 4
    config_vals[2] = [first_addr_AP, first_addr_AT] # 2, 3
    config_vals[3] = [first_addr_P] # 5
