...
# Benchmark
kernel_name = f"benchmarks/compigra_blas_paper/satilp/Kalman_2/{CGRA_N_ROWS}x{CGRA_N_COLS}/"
...
def configMemory(A, Q, AP, NI):
    ...
    config_vals[0] = [first_addr_Q, first_addr_A, first_addr_P] # 1, 0, 5
    config_vals[1] = [first_addr_AP, first_addr_AT, first_addr_APA] # 2, 3, 4
    config_vals[2] = [first_addr_AT] # 3
...
runKernel(load_addrs, max_it=200000000000, printVal=0)
