...
def configMemory(A, Q, AP, NI):
    ...
    config_vals[0] = [] # 
    config_vals[1] = [first_addr_AT] # 3
    config_vals[2] = [first_addr_P, first_addr_AP] # 5, 2
    config_vals[3] = [first_addr_APA] # 4
    config_vals[4] = [first_addr_A, first_addr_AT, first_addr_Q] # 0, 3, 1
