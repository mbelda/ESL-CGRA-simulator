...
# Benchmark
kernel_name = f"benchmarks/compigra_blas_paper/satilp/Kalman_1/{CGRA_N_ROWS}x{CGRA_N_COLS}/"
...
def configMemory(A, x, P, NI):
    ...
    if version == "_out_5_I24_J24_K24":
        config_vals[0] = [first_addr_x] # 1
        config_vals[1] = [first_addr_P] # 2
        config_vals[2] = [first_addr_x, first_addr_A, first_addr_AP] # 1, 0, 4
        config_vals[3] = [first_addr_Ax] # 3
        config_vals[4] = [first_addr_A] # 0
    if version == "_out_5_I60_J60_K60":
        config_vals[0] = [first_addr_x, first_addr_AP] # 1, 4
        config_vals[1] = [first_addr_P] # 2
        config_vals[2] = [first_addr_x, first_addr_A] # 1, 0
        config_vals[3] = [first_addr_Ax] # 3
        config_vals[4] = [first_addr_A] # 0
