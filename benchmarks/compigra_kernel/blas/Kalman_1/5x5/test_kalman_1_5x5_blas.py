...
# Benchmark
kernel_name = f"benchmarks/compigra_kernel/blas/Kalman_1/{CGRA_N_ROWS}x{CGRA_N_COLS}/"
...
def configMemory(A, x, P, NI):
    ...
    config_vals[0] = [first_addr_x, first_addr_P] # 1,2
    config_vals[1] = [first_addr_A] # 0
    config_vals[2] = [first_addr_x] # 1
    config_vals[3] = [first_addr_Ax] # 3
    config_vals[4] = [first_addr_A, first_addr_AP] # 0, 4
