...
# Benchmark
kernel_name = f"benchmarks/compigra_kernel/blas/Kalman_2/{CGRA_N_ROWS}x{CGRA_N_COLS}/"
version = f"_out_{CGRA_N_COLS}_I{SIZE}_J{SIZE}_K{SIZE}" + "_ctx"
...
def configMemory(A, Q, AP, NI):
    ...
    if version == "_out_4_I24_J24_K24":
        config_vals[0] = [first_addr_P, first_addr_A] # 5, 0
        config_vals[1] = [first_addr_Q, first_addr_AP] # 1, 2
        config_vals[2] = [first_addr_AT, first_addr_APA] # 3, 4
        config_vals[3] = [first_addr_AT, first_addr_APA] # 3, 4
    if version  == "_out_4_I60_J60_K60":
        config_vals[0] = [first_addr_APA, first_addr_A] # 4, 0
        config_vals[1] = [first_addr_Q, first_addr_AP] # 1, 2
        config_vals[2] = [first_addr_AT, first_addr_P] # 3, 5
        config_vals[3] = [first_addr_AT, first_addr_APA] # 3, 4
